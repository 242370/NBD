...
public class NbdAddressTranslator implements AddressTranslator {
    ...
    public NbdAddressTranslator(DriverContext context) {
    }
    ...
    public InetSocketAddress translate(@NonNull InetSocketAddress inetSocketAddress) {
        ...
        {
            case "172.28.0.2" -> new InetSocketAddress("cassandra1", 9042);
            case "172.28.0.3" -> new InetSocketAddress("cassandra2", 9043);
